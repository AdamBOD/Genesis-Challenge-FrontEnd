...
export class ImagesComponent implements OnInit {
  imagesArray: any[] = [];
  searchPhrase: string;
  url = 'https://api.gettyimages.com/v3/search/images?page=1&page_size=10&sort_order=most_popular&exclude_nudity=true&graphical_styles=illustration&number_of_people=none';
  constructor (private http: HttpClient,
               private route: ActivatedRoute) {}

  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      this.url = 'https://api.gettyimages.com/v3/search/images?page=1&page_size=10&sort_order=most_popular&exclude_nudity=true&graphical_styles=illustration&number_of_people=none';
      if (params['phrase']) {
