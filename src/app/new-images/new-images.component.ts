...
export class NewImagesComponent implements OnInit {
  ...
  baseURL = 'https://api.gettyimages.com/v3/search/images?page=1&page_size=10&sort_order=newest&exclude_nudity=true&graphical_styles=illustration&number_of_people=none';
  url = this.baseURL;
